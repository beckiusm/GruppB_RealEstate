                                ...
                                ?>
                                        <?php if ($counter <= 0) { ?>
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" alt="First slide" src="<?php echo $full_image_url; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>">
                                            </div>
                                        <?php $counter = $counter + 1;
                                        } elseif ($counter = 1) { ?>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" alt="Second slide" src="<?php echo $full_image_url; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>">
                                            </div>
                                        <?php } elseif ($counter = 2) { ?>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" alt="Third slide" src="<?php echo $full_image_url; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>">
                                            </div>
                                        <?php } ?>
